...
/*this is delet quer*/
mysqli_query($link,"delete from users where u_id='$user_id'")or die("query is incorrect...");
}
...
?>
	...
	<th><a href="adduser.php" class="btn btn-success">Add New</a></th>
                    ...
                    <tbody>
                      <?php
                        $result=mysqli_query($link,"select u_id, email, u_name from users")or die ("query 2 incorrect.......");
                        ...
                        echo "<tr><td>$user_name</td><td>$user_email</td>";
